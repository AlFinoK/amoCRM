      ...
      <div className="container">
        <div className="footer-top">
          <div className="footer-top__about">
            <h2 className="footer-top__title">О КОМПАНИИ</h2>
          ...
          <div className="footer-top__menu ">
            <h2 className="footer-top__title">МЕНЮ</h2>
            <ul className="footer-top__list two-columns">
          ...
          <div className="footer-top__contacts">
            <h2 className="footer-top__title">КОНТАКТЫ</h2>
            <div className="footer-top__contacts-inner">
              <Link to="tel: +75555555555" className="footer-top__contacts-tel">
                +7 555 555-55-55
              </Link>
              <div className="footer-top__contacts-socials">
                <Link className="telegram" to="/">
                  <svg
                    ...
                    <path
                      d="M16.2208 0.0978383L1.44583 5.79534C0.437498 6.20034 0.443331 6.76284 1.26083 7.01367L5.05416 8.197L13.8308 2.6595C14.2458 2.407 14.625 2.54284 14.3133 2.8195L7.2025 9.237H7.20083L7.2025 9.23784L6.94083 13.1478C7.32416 13.1478 7.49333 12.972 7.70833 12.7645L9.55083 10.9728L13.3833 13.8037C14.09 14.1928 14.5975 13.9928 14.7733 13.1495L17.2892 1.29284C17.5467 0.260338 16.895 -0.207162 16.2208 0.0978383Z"
                      fill="#E4E5EA"
                    />
                  </svg>
                </Link>
              ...
              <div className="footer-top__contacts-address">Москва, Путевой проезд 3с1, к 902</div>
            </div>
          </div>
        </div>
